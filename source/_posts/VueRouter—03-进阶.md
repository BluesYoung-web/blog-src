...
export default {
  ...
  setup(props) {
    ...
    // isActive: 如果需要应用 active class 则为 true、isExactActive: 如果需要应用exact active class 则为 true
...
// aborted: 导航守卫返回了 false，cancelled: 导航完成之前又产生了新的导航，duplicated: 已经处于目标位置，导航被阻止
